...
export default function MessagingPage() {
  ...
  useEffect(() => {
    async function fetchSenderReceiver() {
      try {
        const response = await fetch(`https://kaya.ng/kaya-api/chat/get-chat-id.php?package_id=${packageId}`);
  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      try {
        const res = await fetch(`https://kaya.ng/kaya-api/chat/fetch-messages.php?package_id=${packageId}`);
  ...
  const sendMessage = async () => {
    ...
    try {
      // Send to API
      await fetch('https://kaya.ng/kaya-api/chat/send-message.php', {
        method: 'POST',
...
const handleMicClick = async () => {
  if (!isRecording) {
    ...
    mediaRecorder.onstop = () => {
      ...
      fetch('https://kaya.ng/kaya-api/chat/send-audio.php', {
        method: 'POST',
        body: formData,
      }).catch(console.error);
    };
