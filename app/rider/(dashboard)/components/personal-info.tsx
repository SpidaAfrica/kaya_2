...
export const PersonalInfo: React.FC<StepProps> = ({ setActiveStep }) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const response = await fetch(apiUrl("rider/save-personal-info.php"), {
        method: "POST",
        body: formData,
      });
...
export const VehicleInfo: React.FC<StepProps> = ({ setActiveStep }) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const response = await fetch(apiUrl("rider/save-vehicle-info.php"), {
        method: "POST",
        body: formData,
      });
...
export const GuarantorInfo: React.FC<StepProps> = ({ setActiveStep }) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      const response = await fetch(apiUrl("rider/guarantor-info.php"), {
        method: "POST",
        body: formData,
      });
